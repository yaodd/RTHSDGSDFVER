...
- (void)viewDidLoad
{
    ...
    [logo setFrame:CGRectMake(63, 140, image.size.width * 3 / 4, image.size.height * 3 / 4)];
    [self.view addSubview:logo];
    
    UILabel *compCN = [[UILabel alloc]initWithFrame:CGRectMake(65, 400, 300, 30)];
    ...
    UILabel *compEN = [[UILabel alloc]initWithFrame:CGRectMake(60, 420, 400, 30)];
