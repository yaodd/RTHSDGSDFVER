...
NSString *ImageName = @"setting_text_field";
NSString *btnImageName = @"setting_button";
...
- (void)initViews{
    ...
    [originalPswLabel setText:@"请输入验证码"];
    ...
    [originalPswTF setBackground:[UIImage imageNamed:ImageName]];
    ...
    [newFirstPswTF setBackground:[UIImage imageNamed:ImageName]];
    ...
    [newSecondPswTF setBackground:[UIImage imageNamed:ImageName]];
    ...
    [sureButton setBackgroundImage:[UIImage imageNamed:btnImageName] forState:UIControlStateNormal];
    [sureButton setTitle:@"重置" forState:UIControlStateNormal];
